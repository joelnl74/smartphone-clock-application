...
{
    [TestFixture]
    public class TimerLapModelTests
    {
        ...
        {
            // Arrange.
            var data = new TimerLapModel { globalTimeSpan = new System.TimeSpan(0, 0, _timeStamp) };
        ...
        public void SameData_ShouldSucceedEquality()
        {
            // Arrange.
            var data = new TimerLapModel { globalTimeSpan = new System.TimeSpan(0, 0, _timeStamp) };
            var otherData = new TimerLapModel { globalTimeSpan = new System.TimeSpan(0, 0, _timeStamp) };
        ...
        public void NullInstance_ShouldFailEqualityObjectComparer()
        {
            // Arrange.
            var data = new TimerLapModel { globalTimeSpan = new System.TimeSpan(0, 0, _timeStamp) };
            TimerLapModelTests otherData = null;
        ...
        public void DifferentId_ShouldFailEquality()
        {
            // Arrange.
            var data = new TimerLapModel { globalTimeSpan = new System.TimeSpan(0, 0, _timeStamp) };
            var otherData = new TimerLapModel { globalTimeSpan = new System.TimeSpan(0, 0, _otherTimeStamp) };
